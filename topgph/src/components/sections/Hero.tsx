...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Image with Overlay and Subtle Animated Gradient */}
        ...
        <div className="max-w-3xl">
          ...
          >
            <button
              ...
              className="flex items-center justify-center gap-2 px-8 py-4 rounded-full font-bold bg-primary text-primary-foreground hover:bg-secondary hover:-translate-y-1 transition-all duration-300 gold-glow"
            >
              Our Services
